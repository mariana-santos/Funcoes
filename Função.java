...
public class Função {
	public static void main(String[] args) {
		...
		System.out.println("Digite 2 para calcular a tabuada de um número");
		System.out.println("Digite 3 para saber quantos anos faltam para sua aposentadoria");
		System.out.println("Digite 4 para calcular a potência de um número");
		...
		case 1:
			...
			break;
		case 2:
			System.out.println("Digite o númeor para saber sua tabuada");
			int tab = in.nextInt();
			tabuada(tab);
			break;
		case 3:
			...
			System.out.println("Faltam "+aposentadoria(sexo, idade)+" anos para você se aposentar");
			break;
		case 4:
